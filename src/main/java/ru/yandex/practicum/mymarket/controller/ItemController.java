...
public class ItemController {
    ...
    public String showItems(
        ...
        Page<ItemDto> itemDtoPage = itemService.getAllItems(search, sort, pageNumber, pageSize);
        ...
        model.addAttribute("paging", new PagingInfo(pageSize, pageNumber, itemDtoPage.hasPrevious(), itemDtoPage.hasNext()));
