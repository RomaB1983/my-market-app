...
insert into items(price,description,img_path,title) values(1::bigint,'Мяч','/images/1.jpg','мяч');
insert into items(price,description,img_path,title) values(20::bigint,'Мяч1','/images/2.jpg','мяч1');
insert into items(price,description,img_path,title) values(3::bigint,'Мяч2','_','мяч2');
insert into items(price,description,img_path,title) values(40::bigint,'Мяч3','_','мяч3');
