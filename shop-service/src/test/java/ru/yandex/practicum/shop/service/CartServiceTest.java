...
class CartServiceTest {
    ...
    {
        cartItem1.setId(1L);
        cartItem1.setUsername(USER_ID);
        cartItem1.setItemId(1L);
        cartItem1.setQuantity(2);

        cartItem2.setId(2L);
        cartItem2.setUsername(USER_ID);
    ...
    void test_getCartItems_Success() {
        when(cartItemRepository.findByUsername(eq(USER_ID)))
        ...
        Mono<List<ItemDto>> result = cartService.getCartItems(USER_ID);
        ...
        verify(cartItemRepository, times(1)).findByUsername(USER_ID);
    ...
    void test_modifyItem_AddNewItem() {
        when(cartItemRepository.findByUsernameAndItemId(eq(USER_ID), eq(1L)))
        ...
        Mono<Void> result = cartService.modifyItem(USER_ID, 1L, 3);

        StepVerifier.create(result)
                .verifyComplete();

        verify(cartItemRepository, times(1))
                .findByUsernameAndItemId(USER_ID, 1L);
        verify(itemRepository, times(1)).findById(1L);
        verify(cartItemRepository, times(1)).save(argThat(cartItem ->
                cartItem.getUsername().equals(USER_ID) &&
    ...
    void test_modifyItem_UpdateExistingItem() {
        ...
        Mono<Void> result = cartService.modifyItem(USER_ID, 1L, 2);
    ...
    void test_removeItem_Success() {
        ...
        Mono<Void> result = cartService.removeItem(USER_ID, 1L);
    ...
    void test_updateQuantity_Plus() {
        ...
        Mono<Void> result = cartService.updateQuantity(USER_ID, 1L, "PLUS");
    ...
    void test_updateQuantity_Minus() {
        ...
        Mono<Void> result = cartService.updateQuantity(USER_ID, 1L, "MINUS");
    ...
    void test_updateQuantity_Delete() {
        ...
        Mono<Void> result = cartService.updateQuantity(USER_ID, 1L, "DELETE");
    ...
    void test_updateQuantity_InvalidAction() {
        Mono<Void> result = cartService.updateQuantity(USER_ID, 1L, "INVALID");

        StepVerifier.create(result)
                .verifyComplete();

        verify(cartItemRepository, never())
                .findByUsernameAndItemId(anyString(), anyLong());
        verify(cartItemRepository, never()).save(any());
    ...
    void test_updateQuantity_NullAction() {
        Mono<Void> result = cartService.updateQuantity(USER_ID, 1L, null);
    ...
    void test_getItemCount_ItemExists() {
        ...
        Mono<Integer> result = cartService.getItemCount(USER_ID, 1L);
    ...
    void test_getItemCount_ItemNotInCart() {
        when(cartItemRepository.findByUsernameAndItemId(eq(USER_ID), eq(999L)))
                .thenReturn(Mono.empty());

        Mono<Integer> result = cartService.getItemCount(USER_ID, 999L);
        ...
        verify(cartItemRepository, times(1))
                .findByUsernameAndItemId(USER_ID, 999L);
    }
    ...
    void test_removeItem_ItemNotExists() {
        ...
        Mono<Void> result = cartService.removeItem(USER_ID, 999L);
