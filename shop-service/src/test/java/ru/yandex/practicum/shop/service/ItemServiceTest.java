...
class ItemServiceTest {
    ...
    void test_getAllItems_DefaultParams() {
        ...
        when(cartService.getItemCount(eq(USER_ID), anyLong()))
                .thenReturn(Mono.just(1));

        Mono<Page<ItemDto>> result = itemService.getAllItems(null, "NO", 1, 5, USER_ID);
    ...
    void test_getAllItems_WithSearch() {
        ...
        Mono<Page<ItemDto>> result = itemService.getAllItems(search, "NO", 1, 5, USER_ID);
    ...
    void test_getAllItems_WithSortByPrice() {
        ...
        Mono<Page<ItemDto>> result = itemService.getAllItems(null, "PRICE", 1, 5, USER_ID);
    ...
    void test_getItemById_Success() {
        when(cacheService.getItemById(eq(USER_ID), eq(1L)))
                .thenReturn(Mono.just(item1));
        when(itemRepository.findById(eq(1L)))
                .thenReturn(Mono.just(item1));
        when(cartService.getItemCount(eq(USER_ID), eq(1L)))
                .thenReturn(Mono.just(5));

        Mono<ItemDto> result = itemService.getItemById(USER_ID, 1L);
        ...
        verify(cartService, times(1)).getItemCount(USER_ID, 1L);
    }
    ...
    void test_getAllItems_WithSortByAlpha() {
        ...
        Mono<Page<ItemDto>> result = itemService.getAllItems(null, "ALPHA", 1, 5, USER_ID);
    ...
    void test_setCount_Success() {
        ...
        Mono<ItemDto> result = itemService.setCount(USER_ID, itemDto1);
    ...
    void test_setCount_CartServiceReturnsZero() {
        when(cartService.getItemCount(eq(USER_ID), eq(2L)))
                .thenReturn(Mono.just(0));

        Mono<ItemDto> result = itemService.setCount(USER_ID, itemDto2);
        ...
        verify(cartService, times(1)).getItemCount(USER_ID, 2L);
    }
    ...
    void test_getAllItems_WithSearchAndSort() {
        ...
        Mono<Page<ItemDto>> result = itemService.getAllItems(search, "PRICE", 1, 5, USER_ID);
